...
interface EtlOrchestrator {
    ...
    suspend fun run(context: EtlContext, initTimestamp: Instant = Instant.EPOCH): List<EtlProcessingResult>
    suspend fun rerun(context: EtlContext, initTimestamp: Instant = Instant.EPOCH, withDataDeletion: Boolean): List<EtlProcessingResult>
}
