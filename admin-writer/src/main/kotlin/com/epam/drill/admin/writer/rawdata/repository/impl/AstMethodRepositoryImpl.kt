...
class AstMethodRepositoryImpl: AstMethodRepository {
    override fun createMany(data: List<AstEntityData>) {
    ...
    override fun findAllByInstanceIds(instanceIds: List<String>): List<AstEntityData> {
