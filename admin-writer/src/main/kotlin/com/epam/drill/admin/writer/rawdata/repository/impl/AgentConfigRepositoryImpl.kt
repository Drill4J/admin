...
class AgentConfigRepositoryImpl: AgentConfigRepository {

    override fun create(agentConfig: AgentMetadata): Int {
    ...
    override fun findAllByAgentIdAndBuildVersion(agentId: String, buildVersion: String): List<AgentMetadata> {
