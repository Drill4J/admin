...
CREATE UNIQUE INDEX method_coverage_table_pk ON metrics.method_coverage_table (group_id, app_id, method_id, build_id, app_env_id, test_launch_id, creation_day);
