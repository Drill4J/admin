...
class ApiRoot(val prefix: String = "api") {
    ...
    data class Agents(val parent: ApiRoot) {
        ...
        @Group(AGENT_PLUGIN)
        @Location("/{agentId}/environments/{envId}/plugins/{pluginId}/dispatch-action")
        data class DispatchPluginActionForEnv(val parent: Agents, val agentId: String, val envId: String, val pluginId: String)
